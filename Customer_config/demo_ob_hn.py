...
stack_config = {"Enable": True, "Func": "Special", "Default": 0.51,
                "Specify": {'a_hn_101': 0.59, 'a_dl_102': 0.59, 'a_dp_101': 0.59, 'a_hn_102': 0.54,
                            'a_hn_201': 0.54}}
...
process_pipeline = [
    ...
    dict(type='Postprocess',
         pipline=[
             dict(type='Hn_ob_computelayer', stack_config=stack_config,
